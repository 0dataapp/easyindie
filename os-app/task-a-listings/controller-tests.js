...
describe('_DataListingObjects', function test__DataListingObjects() {
    ...
    $scope.apps = null;`;
		...
		it('parses listing', function () {
			...
			const EASPlatformTags = Array.from(Array(uRandomInt(5))).map(function () {
				return Math.random().toString();
			});
